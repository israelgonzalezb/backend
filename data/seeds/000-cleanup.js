exports.seed = async function(knex) {
  try {
    await knex.raw("TRUNCATE TABLE Habit_Tracking RESTART IDENTITY CASCADE");
    await knex.raw("TRUNCATE TABLE User_Habits RESTART IDENTITY CASCADE");
    await knex.raw("TRUNCATE TABLE User_Categories RESTART IDENTITY CASCADE");
